...
import com.app.cryo2.cryo2.Adapters.Adaptador;
...
public class HistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_history, container, false);


        listaDatos = vista.findViewById(R.id.lstDatosFavores);
        linear = vista.findViewById(R.id.idlinearlayoutu);

        fab = vista.findViewById(R.id.floatingActionButtton);
        fab1 = vista.findViewById(R.id.floatingActionButtton1);
        fab2 = vista.findViewById(R.id.floatingActionButtton2);
        fab3 = vista.findViewById(R.id.floatingActionButtton3);

        fal1 = vista.findViewById(R.id.FloatLblPedirFavor);
        fal2 = vista.findViewById(R.id.FloatLblInformarAveria);
        fal3 = vista.findViewById(R.id.FloatLblReservaIns);
        ...
        Lista.add(new DatosPerfil(9, "Rana", "Partido padel 19:00h falta 1 persona", R.drawable.profile_img, 2));
        ...
        Lista.add(new DatosPerfil(12, "Pez Payaso", "Animal en peligro de extincion", R.drawable.profile_img, 1));
...
*/
        ...
        return vista;  ///provisional, borrar al descomentar(el return esta abajo comentado)
